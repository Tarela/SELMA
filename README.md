...
#### Please cite this paper if SELMA helps on your research: Hu, S.S., Liu, L., Li, Q. et al. Intrinsic bias estimation for improved analysis of bulk and single-cell chromatin accessibility profiles using SELMA. Nat Commun 13, 5533 (2022). https://doi.org/10.1038/s41467-022-33194-z [(download citation)](https://citation-needed.springer.com/v2/references/10.1038/s41467-022-33194-z?format=refman&flavour=citation) <br>
